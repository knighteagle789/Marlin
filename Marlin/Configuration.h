...
#define STRING_CONFIG_H_AUTHOR "Jeremy Woods" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NocoWoods 3D Printer"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  58.15
    #define DEFAULT_Ki   3.80
    #define DEFAULT_Kd 222.19
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  316.59
  #define DEFAULT_bedKi   63.25
  #define DEFAULT_bedKd 1056.34
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 21.89, 5, 0 }
